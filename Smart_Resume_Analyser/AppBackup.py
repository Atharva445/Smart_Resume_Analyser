...
# # Load master skills dataset
# skills_df = pd.read_csv("skills_list.csv")  
# all_skills = set(skills_df["skill"].str.lower().tolist())  # convert to lowercase set for fast lookup
...
#     # base_dir points to Smart_Resume_Analyser folder (where App.py is)
...
#         "NumberOfPlatformsKnown": resume_data.get("NumberOfPlatformsKnown", 0),
#         "OrgSize": resume_data.get("OrgSize", "")
#     }

#     # DEBUG: Print extracted features
#     print("Extracted features for salary prediction:", input_data)
...
#                 matched_skills = [skill for skill in all_skills if skill in resume_text_lower]

#                 keywords = st_tags(
#                     label='### Skills detected in your Resume',
